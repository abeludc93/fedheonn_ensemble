...
from examples.utils import global_fit, load_skin_dataset
...
def main():
    ...
    n_estimators_lst    = [5, 25]
    p_samples_lst       = [0.7, 1.0]
    p_features_lst      = [0.7, 1.0]
    ...
    filename = f"skin_gs_cv_{'bagging' if bag else 'normal'}_{timestamp}.xlsx"
