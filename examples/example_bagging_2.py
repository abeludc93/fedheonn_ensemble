...
X, y = make_regression(n_samples=1000, n_features=2, noise=0.2, random_state=42, n_targets=2)
...
for i in range(0, n_clients):
    clients.append(FedHEONN_regressor(f='linear', context=ctx, bagging=True, n_estimators=n_estimators))
...
coordinator = FedHEONN_coordinator(f='lin', lam=0.01, bagging=True)
