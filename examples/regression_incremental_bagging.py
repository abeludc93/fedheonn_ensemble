...
"""
Example of using FedHEONN method for a regression task, with and without incremental grouping.
"""
...
coordinator = FedHEONN_coordinator(f=f_act, lam=lam, encrypted=enc, sparse=spr, ensemble=ens_coord)
...
mse_inc, w_inc = incremental_fit(list_clients=lst_clients, ngroups=n_groups, coord=coordinator,
