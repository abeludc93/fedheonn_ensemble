...
# Application modules
from examples.utils import load_mnist_digits,  gridsearch_cv_classification, export_dataframe_results
...
def main():
    ...
    # EXPORT RESULTS
    export_dataframe_results(dict_no_bag=dict_no_bag, dict_bag=dict_bag, dataset_name="MNIST", regression=False)
